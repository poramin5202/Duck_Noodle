...
export default {
    methods: {
       async next() {
            if(this.form.name!=null && this.form.im!=null){
               await this.$axios.patch(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/Datamenu/${this.form.key}.json`, this.form)  
                this.$router.go(0);
            }
        },
       async dele() {
         await this.$axios.delete(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/Datamenu/${this.del}.json`);
         this.$router.go(0);
    ...
    async mounted() {
        ...
        await this.$axios.get(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/Datamenu.json`)
                  .then((res) => {
