...
export default {
    methods: {
       ...
       async dele() {
         await this.$axios.delete(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/DataNoodle/${this.del}.json`);
         this.$router.go(0);
    ...
    async mounted() {
        ...
        await this.$axios.get(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/DataNoodle.json`).then((res) => {
            this.items = res.data
        ...
        await this.$axios.get(`https://duck-noodle-default-rtdb.asia-southeast1.firebasedatabase.app/DataNoodle.json`)
                  .then((res) => {
